...
| `Precision.BlockScale` | block scaling makes the dead zone relative: NVFP4 drops a key below `1/24` of its block maximum, but at most `255/384` of the mass, at any length |
...
import Transformer.Precision.BlockScale
